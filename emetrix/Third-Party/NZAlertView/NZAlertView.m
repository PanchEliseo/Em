...
#import "UIView+EMViewExtension.h"
...
- (void)hide
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(NZAlertViewWillDismiss:)]) {
    ...
    [UIView animateWithDuration:_animationDuration animations:^{
        ...
        if (finished) {
            ...
            if (self.delegate && [self.delegate respondsToSelector:@selector(NZAlertViewDidDismiss:)]) {
...
{
    self.tag = EMViewTagNotRotate;
    self.view.tag = EMViewTagNotRotate;
    self.backgroundBlackView.tag = EMViewTagNotRotate;
    self.backgroundView.tag = EMViewTagNotRotate;
    self.imgShadow.tag = EMViewTagNotRotate;
    ...
    if (self.delegate &&[self.delegate respondsToSelector:@selector(willPresentNZAlertView:)]) {
    ...
    [UIView animateWithDuration:_animationDuration animations:^{
        ...
        if (finished)
        {
            if (self.delegate && [self.delegate respondsToSelector:@selector(didPresentNZAlertView:)])
            {

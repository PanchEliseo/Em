...
- (NSString *)timeFormattedToSendStringForValue:(unsigned long long)value
{
    unsigned long long msperhour = 3600000;
    unsigned long long mspermin = 60000;
    ...
    if (hrs == 0) {
        if (mins == 0) {
            formattedString = self.displayMode == kDisplayModeFull ? [NSString stringWithFormat:@"00:%02llu:%02llu", secs, frac] : [NSString stringWithFormat:@"00:%02llu:00", secs];
        } else {
            formattedString = self.displayMode == kDisplayModeFull ? [NSString stringWithFormat:@"%02llu:%02llu:%02llu", mins, secs, frac] : [NSString stringWithFormat:@"%02llu:%02llu:00", mins, secs];
        }
    } else {
        formattedString = self.displayMode == kDisplayModeFull ? [NSString stringWithFormat:@"%02llu:%02llu:%02llu:%02llu", hrs, mins, secs, frac] : [NSString stringWithFormat:@"%02llu:%02llu:%02llu:00", hrs, mins, secs];
    }
